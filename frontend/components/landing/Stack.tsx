      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {STACK.map((name) => (
            <div
              key={name}
              className="bg-[#0F0F12] border border-white/[0.08] rounded-xl px-6 py-5 text-center min-w-[110px] transition-all duration-200 hover:border-[#7C3AED] hover:-translate-y-0.5"
            >
