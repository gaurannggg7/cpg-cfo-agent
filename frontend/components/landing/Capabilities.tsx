      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {CAPABILITIES.map(({ name, description, icon: Icon }) => (
            <div
              key={name}
              className="bg-[#0F0F12] border border-white/[0.08] rounded-xl p-6 transition-all duration-200 hover:scale-[1.03] hover:border-[#7C3AED] hover:shadow-[0_0_24px_rgba(124,58,237,0.25)]"
            >
